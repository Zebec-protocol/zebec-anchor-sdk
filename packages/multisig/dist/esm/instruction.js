...
class ZebecTransactionBuilder {
    ...
    execStreamInitToken(safeAddress, safeDataAccount, zebecTransactionAccount, streamDataAccountAddress, withdrawDataAccount, feeReceiverAddress, feeVaultDataAddress, feeVaultAddress, senderAddress, receiverAddress, tokenMintAddress, startTime, endTime, amount) {
        return __awaiter(this, void 0, void 0, function* () {
            const startTimeBN = new anchor_1.BN(startTime);
            const endTimeBN = new anchor_1.BN(endTime);
            const amountBN = new anchor_1.BN(amount);
    ...
    execStreamPauseToken(safeAddress, receiverAddress, streamDataAccountAddress, zebecTransactionAccount, safeDataAccount, senderAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            const txAccountSize = 1000;
    ...
    execStreamResumeToken(safeAddress, receiverAddress, streamDataAccountAddress, zebecTransactionAccount, safeDataAccount, senderAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            const txAccountSize = 1000;
    ...
    execStreamCancelToken(zebecVaultAddress, safeAddress, receiverAddress, streamDataAccountAddress, zebecTransactionAccount, safeDataAccount, senderAddress, withdrawDataAccountAddress, feeReceiverAddress, feeVaultDataAddress, feeVaultAddress, tokenMintAddress, pdaTokenData, destTokenData, feeTokenData) {
        return __awaiter(this, void 0, void 0, function* () {
            const txAccountSize = 1000;
    ...
    execInstantStreamToken(zebecVaultAddress, safeAddress, receiverAddress, zebecTransactionAccount, safeDataAccount, senderAddress, withdrawDataAccountAddress, tokenMintAddress, pdaTokenData, destTokenData) {
        return __awaiter(this, void 0, void 0, function* () {
            const txAccountSize = 1000;
            const zebecCancelStreamAccounts = accounts_1.AccountKeys.instanttransfertoken(zebecVaultAddress, receiverAddress, safeAddress, withdrawDataAccountAddress, tokenMintAddress, pdaTokenData, destTokenData);
