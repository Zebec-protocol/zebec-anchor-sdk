...
class AccountKeys {
    ...
    static updateinit(streamDataAccountAddress, withdrawDataAccountAddress, safeAddress, receiverAddress) {
        return [
            { pubkey: streamDataAccountAddress, isSigner: false, isWritable: true },
            { pubkey: withdrawDataAccountAddress, isSigner: false, isWritable: true },
            { pubkey: safeAddress, isSigner: true, isWritable: true },
    ...
    static transferfromsafe(safeAddress, receiverAddress) {
        return [
            { pubkey: safeAddress, isSigner: true, isWritable: true },
            { pubkey: receiverAddress, isSigner: false, isWritable: true },
            { pubkey: web3_js_1.SystemProgram.programId, isSigner: false, isWritable: false }
    ...
    static transfertokenfromsafe(safeAddress, receiverAddress, tokenMintAddress, destTokenAddress, sourceTokenAddress) {
        return [
            { pubkey: safeAddress, isSigner: true, isWritable: true },
            { pubkey: receiverAddress, isSigner: false, isWritable: true },
            { pubkey: web3_js_1.SystemProgram.programId, isSigner: false, isWritable: false },
    ...
    static updateinittoken(streamDataAccountAddress, withdrawDataAccountAddress, safeAddress, receiverAddress, tokenMintAddress) {
        return [
            { pubkey: streamDataAccountAddress, isSigner: false, isWritable: true },
            { pubkey: withdrawDataAccountAddress, isSigner: false, isWritable: true },
            { pubkey: safeAddress, isSigner: true, isWritable: true },
