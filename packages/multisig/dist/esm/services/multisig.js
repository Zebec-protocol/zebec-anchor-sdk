...
class ZebecTokenTreasury extends ZebecMultisig {
    ...
    init(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const anchorTx = yield this.transactionBuilder.execStreamInitToken(safeAddress, safeDataAccount, zebecTransactionAccount, streamDataAccount, withdrawDataAccount, this.feeReceiverAddress, feeVaultDataAddress, feeVaultAddress, senderAddress, receiverAddress, tokenMintAddress, start_time, end_time, amountInLamports);
            const tx = yield this._makeTxn(anchorTx, [streamDataAccount, zebecTransactionAccount]);
            const signedRawTx = yield this.anchorProvider.wallet.signTransaction(tx);
            this.consolelog.info('transaction after signing: ', signedRawTx);
            try {
    ...
    pause(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const senderAddress = new web3_js_1.PublicKey(sender);
            const zebecTransactionAccount = web3_js_1.Keypair.generate();
            const anchorTx = yield this.transactionBuilder.execStreamPauseToken(safeAddress, receiverAddress, streamDataAccountAddress, zebecTransactionAccount, safeDataAccount, senderAddress);
            const tx = yield this._makeTxn(anchorTx, [zebecTransactionAccount]);
            const signedRawTx = yield this.anchorProvider.wallet.signTransaction(tx);
            this.consolelog.info('transaction after signing: ', signedRawTx);
            try {
    ...
    instanttransfer(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const destTokenData = yield this._getAccociatedTokenAddress(receiverAddress, tokenMintAddress);
            const zebecTransactionAccount = web3_js_1.Keypair.generate();
            const anchorTx = yield this.transactionBuilder.execInstantStreamToken(zebecVaultAddress, safeAddress, receiverAddress, zebecTransactionAccount, safeDataAccount, senderAddress, withdrawDataAccountAddress, tokenMintAddress, pdaTokenData, destTokenData);
            const tx = yield this._makeTxn(anchorTx, [zebecTransactionAccount]);
            const signedRawTx = yield this.anchorProvider.wallet.signTransaction(tx);
            this.consolelog.info('transaction after signing: ', signedRawTx);
            try {
