...
exports.ConsoleLog = exports.initAnchorProvider = exports.sleep = exports.now = exports.getClusterTime = exports.getAmountInBN = exports.getTokenAmountInLamports = exports.getAmountInLamports = exports.sendTx = exports.parseErrorMessage = void 0;
const web3_js_1 = require("@solana/web3.js");
const anchor_1 = require("@project-serum/anchor");
const idl_1 = require("../idl");
const parseErrorMessage = (message) => {
    const regex = /error: 0x(.*)/gm;
    const errors = idl_1.ZEBEC_PROGRAM_IDL.errors;
    let m, errcode;
