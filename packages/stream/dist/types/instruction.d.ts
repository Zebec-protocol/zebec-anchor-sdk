...
export declare class ZebecTransactionBuilder {
    ...
    execUpdteFeeVault(feeReceiverAddress: PublicKey, feeVaultAddress: PublicKey, feeVaultDataAddress: PublicKey, feePercentage: number): Promise<Transaction>;
    ...
    execStreamUpdateSol(escrowAccountPublicKey: PublicKey, withdrawEscrowDataAccountAddress: PublicKey, senderAddress: PublicKey, receiverAddress: PublicKey, startTime: number, endTime: number, amount: number): Promise<Transaction>;
    ...
    execUpdateStreamInitToken(escrowAccountPublicKey: PublicKey, withdrawEscrowDataAccountAddress: PublicKey, senderAddress: PublicKey, receiverAddress: PublicKey, tokenMintAddress: PublicKey, startTime: number, endTime: number, amount: number): Promise<Transaction>;
